...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onStart() {
        ...
        TextView textView_register = findViewById(R.id.login_textView_register);
        ...
        Button button_login_submit = (Button) findViewById(R.id.login_button_submit);
        button_login_submit.setOnClickListener(v -> {
            EditText edit_text_username = (EditText) findViewById(R.id.login_editText_username);
            EditText edit_text_password = (EditText) findViewById(R.id.login_editText_password);
